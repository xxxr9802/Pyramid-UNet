...
cv2.rectangle(image_box, top_left, bottom_right, (0, 255, 0), 2)
...
for i in range(len(x2)):
    ...
    if abs(x2[i] - x1) > 600 or abs(y2[i] - y1) > 600:
        ...
        if count >= 4:  #There are at least 3 points nearby, plus at least 4 points on its own
